...
const perovskiteSection = document.getElementById('perovskite')
const camera = new THREE.PerspectiveCamera(
  45,
  perovskiteSection.clientWidth / perovskiteSection.clientWidth,
  0.1,
  1000
)
const renderer = new THREE.WebGLRenderer()
renderer.setSize(
  perovskiteSection.clientWidth * 0.5,
  perovskiteSection.clientWidth * 0.5
)
//renderer.setSize(window.innerWidth, window.innerHeight)
perovskiteSection.appendChild(renderer.domElement)
...
function handleWindowResize() {
  const newWidth = perovskiteSection.clientWidth * 0.5

  const newHeight = perovskiteSection.clientWidth * 0.5
